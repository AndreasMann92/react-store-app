...
import {getAuth, signInWithRedirect, signInWithPopup, GoogleAuthProvider, UserInfo, createUserWithEmailAndPassword, signInWithEmailAndPassword} from 'firebase/auth'
